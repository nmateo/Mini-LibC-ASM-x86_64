...
loop:
    cmp rcx, rdx                ; sub byte [rdi + rcx], 0 without altering the operands,
    ...
    jg sup                      ; conditional jump to sup if none of the flags are set
    ...
    jmp loop                    ; unconditional jump to incr
